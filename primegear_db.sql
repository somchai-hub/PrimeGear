...
--
-- Host: localhost:3306
-- Generation Time: Sep 07, 2026 at 04:41 AM
...
(3, 'Samsung', 'Galaxy S24 Ultra', 'SmartPhone'),
(4, 'Samsung', 'Galaxy S25 Ultra', 'SmartPhone'),
(5, 'Vivo', 'X300 Pro', 'SmartPhone'),
(6, 'Vivo', 'X200 Pro', 'SmartPhone'),
(7, 'Samsung', 'Galaxy S26 Ultra', 'SmartPhone'),
(9999, 'All', 'Universal', 'None');
...
(11, 'PCK-11', 'Slim Magnet Case สำหรับ Galaxy S26 Ultra', 'https://images.samsung.com/is/image/samsung/p6pim/th/ef-ss948cvegww/gallery/th-galaxy-s26ultra-ss948-ef-ss948cvegww-551659137?$1164_776_PNG$', 'Samsung', 'Slim Magnet Caseเน้นความบางเบา มีรูปทรงที่บางและน้ำหนักเบาซึ่งช่วยปกป้องโดยไม่เพิ่มความหนา ดีไซน์ที่เรียบง่ายและสะอาดตาทำให้อุปกรณ์ของคุณถือสบายมือและพกพาสะดวก\\nสี : Light Violet', 'เคส', 1272);
...
--
-- Dumping data for table `product_device_mapping`
--

INSERT INTO `product_device_mapping` (`product_id`, `device_id`) VALUES
(10, 1),
(11, 7);
...
--
ALTER TABLE `devices`
  MODIFY `Device_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
